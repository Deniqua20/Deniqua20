...
|Identity & Access Management|Cloud Security       |GRC & Compliance |
|----------------------------|---------------------|-----------------|
|Azure AD / Entra ID         |Microsoft Sentinel   |NIST 800-53      |
|RBAC & Conditional Access   |Azure Security Center|SOC 2 & ISO 27001|
|User Lifecycle Management   |Log Analytics & KQL  |HIPAA & FERPA    |
|MFA & SSO Configuration     |Threat Detection     |FedRAMP & PCI-DSS|
|Access Reviews & Auditing   |Incident Response    |Risk Assessment  |
